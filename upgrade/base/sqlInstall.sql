...
('designAppName', 'default', 0, '', 'Ergonomie et design', 'texte', 'nom de l\'application', 'MedKonnect'),
...
('designTopMenuTooltipDisplay', 'default', 0, '', 'Ergonomie et design', 'true/false', 'si true, affiche les infos bulles sur icones du menu supérieur', 'true'),
