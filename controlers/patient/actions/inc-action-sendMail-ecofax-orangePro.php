...
/**
 * Patient > action : envoyer un mail pour ecofax Orange pro
 *
 * @author Bertrand Boutillier <b.boutillier@gmail.com>
 */

$destinataireFAX = trim(str_replace(' ', '', $_POST['mailToEcofaxNumber'])) . '@fax.orange.fr';
...
$mail->addAddress($destinataireFAX);
...
if (!$mail->send()) {
	...
	//to
	$patient->createNewObjetByTypeName('mailTo', $destinataireFAX, $supportID);
	//numero destinataire
