...
$marqueurs['peopleID'] = $match['params']['peopleID'];
$marqueurs['relationID'] = $name2typeID['relationID'];
$marqueurs['relationType'] = $name2typeID[$relationType];
...
" . implode(" ", $tablesSql) . "
where o.toID = :peopleID and o.typeID = :relationID
group by o.value, c.id " . implode("", $groupBy), $marqueurs)) {
