...
if ($p['user']['id']==null) {
    $p['page']['error'][]="Vous n'êtes pas identifié pour PhoneCapture ! Flasher le QR code accessible par votre menu utilisateur une fois identifié dans MedKonnectEHR sur votre ordinateur";
