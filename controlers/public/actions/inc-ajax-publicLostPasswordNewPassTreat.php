...
$userID = msSQL::sqlUniqueChamp("SELECT id from people where lastLostPassRandStr = :randStringControl and lastLostPassDate >= DATE_SUB(NOW(),INTERVAL 10 MINUTE) limit 1", ['randStringControl' => $_POST['randStringControl']]);
